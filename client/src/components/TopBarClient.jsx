      ...
      <AppBar position="fixed" open={open}>
        <Toolbar>
          ...
          <a
            ...
            href={
              !!window.mobileCheck()
                ? "fb://profile/100088276245841"
                : "https://www.facebook.com/people/Felted-fluffies/100088276245841/"
            }
            target="_blank"
            style={{
              color: "white",
          ...
          >
            <Badge badgeContent={shoppingCartCounter} color="secondary">
        ...
        {isAdmin && (
          <>
            ...
            <List>
              <ListItem
                disablePadding
                onClick={() => clickMenuHandler("createProduct")}
              >
                <ListItemButton>
                  <ListItemIcon>
              ...
              <ListItem
                disablePadding
                onClick={() => clickMenuHandler("allProducts")}
              >
                <ListItemButton>
                  <ListItemIcon>
            ...
            <List>
              <ListItem
                disablePadding
                onClick={() => clickMenuHandler("createGroup")}
              >
                <ListItemButton>
                  <ListItemIcon>
                    <AddCircleOutlineIcon
              ...
              <ListItem
                disablePadding
                onClick={() => clickMenuHandler("allGroups")}
              >
                <ListItemButton>
                  <ListItemIcon>
                    <AccountTreeIcon
            ...
            <List>
              <ListItem
                disablePadding
                onClick={() => clickMenuHandler("createRecord")}
              >
                <ListItemButton>
                  <ListItemIcon>
                    <AddCircleOutlineIcon
              ...
              <ListItem
                disablePadding
                onClick={() => clickMenuHandler("allRecords")}
              >
                <ListItemButton>
                  <ListItemIcon>
                    <BookIcon
            ...
            <List>
              <ListItem
                disablePadding
                onClick={() => clickMenuHandler("replicate")}
              >
                <ListItemButton>
                  <ListItemIcon>
                    <CopyAllIcon
